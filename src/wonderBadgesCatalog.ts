...
export const WONDER_BADGE_CATALOG: Record<WonderBadgeId, WonderBadgeCatalogEntry> = {
  ...
  'badge:wj_top100': {
    ...
    acquire: 'Finish ranked 51–100 on the WonderJump leaderboard.',
  },
  'badge:wj_top50': {
    file: 'Top50.png',
    label: 'WonderJump top 50',
    acquire: 'Finish ranked 11–50 on the WonderJump leaderboard.',
  },
  'badge:wj_top10': {
    file: 'Top10.png',
    label: 'WonderJump top 10',
    acquire: 'Finish ranked 4–10 on the WonderJump leaderboard.',
  },
  'badge:wj_top3': {
    file: 'Top3.png',
    label: 'WonderJump top 3',
    acquire: 'Finish ranked #3 on the WonderJump leaderboard.',
  },
  'badge:wj_top2': {
    file: 'Top2.png',
    label: 'WonderJump top 2',
    acquire: 'Finish ranked #2 on the WonderJump leaderboard.',
  },
  'badge:wj_top1': {
    file: 'Top1.png',
    label: 'WonderJump champion',
    acquire: 'Finish ranked #1 on the WonderJump leaderboard.',
  },
}
